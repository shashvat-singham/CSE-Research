...
def find_original_grammar(eps=True):
    ...
    original_grammar = [['S','s','S'],['S','eps','eps'],['A','AS','eps'],['A','a','eps'],['A','Bb','eps'],['B','b','eps']]
    # return get_original_grammar()
    return reverse_grammar(original_grammar)
    
def get_parse_table(convert = False):
    parse_table = [{'non_term':'S','$':'0','s':'0','AS':'0','a':'0','Bb':'0','b':'0'},{'non_term':'A','$':'0','s':'0','AS':'0','a':'0','Bb':'0','b':'0'},{'non_term':'B','$':'0','s':'0','AS':'0','a':'0','Bb':'0','b':'0'}]
    return parse_table
